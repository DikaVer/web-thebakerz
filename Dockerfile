...
ARG NEXT_PRIVATE_BLOB_BACKGROUND_CONTAINER_ARG="dummy"
ARG NEXT_PRIVATE_COSMOS_DB_NAME_ARG="dummy"
ARG NEXT_PRIVATE_GOOGLE_GEO_VALIDATION_ARG="dummy-google-client-secret"
ARG NEXT_PUBLIC_API_BASE_URL_ARG="https://www.thebakerz.com"
ARG NEXT_PUBLIC_AZURE_MAPS_KEY_ARG="dummy-azure-maps-key"
ARG NEXT_PUBLIC_GOOGLE_MAPS_API_KEY_ARG="dummy-google-maps-api-key"
ARG NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY_ARG="pk_test_dummy"
...
ENV NEXT_PRIVATE_COSMOS_DB_KEY=${NEXT_PRIVATE_COSMOS_DB_KEY_ARG} \
    ...
    NEXT_PRIVATE_BLOB_BACKGROUND_CONTAINER=${NEXT_PRIVATE_BLOB_BACKGROUND_CONTAINER_ARG} \
    NEXT_PRIVATE_COSMOS_DB_NAME=${NEXT_PRIVATE_COSMOS_DB_NAME_ARG} \
    NEXT_PRIVATE_GOOGLE_GEO_VALIDATION=${NEXT_PRIVATE_GOOGLE_GEO_VALIDATION_ARG} \
