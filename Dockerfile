...
#ARG NEXT_PUBLIC_API_BASE_URL_ARG="http://localhost:3000" Uncomment during local build
...
#    NEXT_PUBLIC_API_BASE_URL=${NEXT_PUBLIC_API_BASE_URL_ARG} \ Uncomment during local build
