...
export const ItemCategory = ({ children, item }: { children: React.ReactNode; item: any; }) => {
    ...
    return (
        ...
        >
            <motion.div
                ...
                className={'cursor-pointer active:cursor-pointer py-2 px-1'}
            >
                <div>{children}</div>
            </motion.div>
        </Reorder.Item>
...
export const Item = ({ children, item }: { children: React.ReactNode; item: any }) => {
    const y = useMotionValue(0);
    const boxShadow = useRaisedShadow(y);
    const dragControls = useDragControls();
    ...
    return (
        ...
        >
            <svg
                ...
                width='39'
                height='39'
                className='fill-default-300 active:fill-default-400 cursor-grab active:cursor-grabbing'
            >
