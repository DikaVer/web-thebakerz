...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex bg-[#0B0B0F] min-h-[225vh] shrink-0 transform flex-col items-center justify-start [perspective:800px]"
    >
      <motion.h2
        style={{
      ...
      {/* Lid */}
      <div className="scale-x-[0.7] md:scale-x-100">
        <Lid
            src={src}
            scaleX={scaleX}
            scaleY={scaleY}
            ...
            secondImageOpacity={secondImageOpacity}
        />
            {/* Base area */}
            <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-[#272729]">
                ...
                <div className="relative flex h-[10rem] overflow-hidden">
      ...
      <div className="flex flex-col w-full bg-gradient-to-t from-[#0B0B0F] from-17% via-[#1F0322] via-83% to-[#0B0B0F] to-100% items-center justify-start">
        <motion.div
            style={{
            opacity: afterTextOpacity,
            translateY: afterTextTransform,
            }}
        ...
        <motion.div
            ...
            translateY: bottomTextTransform,
            }}
            className={cn(` max-w-2xl px-4 text-center`,
