            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                >
                    <div
                        ...
                        className="relative left-[calc(50%-31rem)] aspect-[1155/1518] sm:aspect-[1155/1118] w-[36.125rem] translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-60rem)] sm:w-[74.1875rem]"
                    />
                </div>
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    {/*<div className={`mb-8 flex justify-center ${aboutusInView ? 'animate-fadeInUpDelay1' : ""} opacity-0`}*/}
                    {/*    ref={aboutusRef}*/}
                    {/*>*/}
                ...
                >
                    <div
                        ...
                        className="relative  aspect-[1155/228] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30  sm:w-[72.1875rem]"
                    />
                </div>
            </div>
        </div>
