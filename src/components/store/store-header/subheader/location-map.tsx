...
const LocationMap: React.FC<LocationMapProps> = ({
    ...
    const staticMapUrl = useMemo(() => {
        ...
        return `https://maps.googleapis.com/maps/api/staticmap?center=${lat},${lng}&zoom=${zoom}&size=${width}x${height}&scale=2&format=png&maptype=roadmap&markers=color:0xa2119d%7C${lat},${lng}&style=feature:all|element:labels.text.fill|color:0x616161&style=feature:all|element:labels.text.stroke|color:0xffffff&style=feature:administrative|element:geometry|color:0xfefefe|weight:1&style=feature:administrative.locality|element:labels.text.fill|color:0x444444&style=feature:administrative.neighborhood|element:labels.text.fill|color:0x757575&style=feature:landscape|element:geometry|color:0xf5f5f5&style=feature:road|element:geometry|color:0xffffff&style=feature:road|element:labels.text.fill|color:0x9e9e9e&style=feature:road.arterial|element:geometry|color:0xfefefe&style=feature:road.arterial|element:labels.text.fill|color:0x757575&style=feature:road.highway|element:geometry|color:0xdadada&style=feature:road.highway|element:labels.text.fill|color:0x424242&style=feature:road.local|element:labels.text.fill|color:0x9e9e9e&style=feature:transit|element:geometry|color:0xe0e0e0&style=feature:transit|element:labels.text.fill|color:0x757575&style=feature:transit.line|element:geometry|color:0x616161&style=feature:transit.station|element:labels.text.fill|color:0x424242&style=feature:water|element:geometry|color:0xc5cae9&style=feature:water|element:labels.text.fill|color:0x6a7b8b&key=${googleMapsApiKey}`;
