          ...
          <ListboxItem
            ...
            startContent={
              isCompact || isNestType ? null : item.icon ? (
                <Icon
                  className={cn(
                    "text-grayText group-data-[selected=true]:text-foreground",
                    iconClassName,
                  )}
                  icon={item.icon}
                  width={24}
                    ...
                    item.icon ? (
                      <div className={"flex h-11 items-center gap-2 px-2 py-1.5"}>
                        <Icon
                          ...
                          width={24}
                        />
                        <span className="text-small font-medium text-grayText group-data-[selected=true]:text-foreground">
                          {item.title}
                        </span>
                      </div>
                    ) : (
    ...
    return (
      <Listbox
        ...
        itemClasses={{
          ...
          title: cn(
            "text-small font-medium text-grayText group-data-[selected=true]:text-foreground",
            itemClasses?.title,
          ),
        }}
        items={items}
